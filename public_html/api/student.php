...
switch ($action) {
    ...
    case 'card_detail':
        ...
        $db = getDB();
        $stmt = $db->prepare('
            SELECT rl.change_amount, rl.balance_after, rl.source, rl.source_detail, rl.created_at,
                   rt.name_ko, rt.coin_value, rt.color
            ...
            LIMIT 50
        ');
        $stmt->execute([$session['student_id'], $code]);
